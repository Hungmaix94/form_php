...
<div class="container">
    ...
    <div class="card">
                <form action="checklogin.php" method="post">
                    <div class="note_error"><?php isset($_SESSION['error_username'])? print_r($_SESSION['error_username']) : ""; ?><?php isset($_SESSION['error_password'])? print_r($_SESSION['error_password']) : ""; ?></div>
